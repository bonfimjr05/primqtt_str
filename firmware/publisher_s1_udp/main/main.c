/*
 * PrioMQTT: No S1 (publicador, alta prioridade)
 * Multiplos ESP32 no Modo 1 (TCP)
 * Disciplina: Sistemas de Tempo Real — UFBA
 *
 * Publica 1 mensagem por segundo no topico sensor/s1,
 * subscreve cmd/s1 para receber o echo reply do controlador
...
static const char *TAG = "PRIOMQTT_S1";
...
void app_main(void)
{
    ...
    xTaskCreate(pub_task,   "pub_task_s1",   4096, NULL, 5, NULL);
    xTaskCreate(stats_task, "stats_task_s1", 2048, NULL, 2, NULL);
}